"""
Django settings for dry_cherry_dev_67810 project.
...
ROOT_URLCONF = 'dry_cherry_dev_67810.urls'
...
WSGI_APPLICATION = 'dry_cherry_dev_67810.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_cherry_dev_67810 API",
    "DESCRIPTION": "API documentation for dry_cherry_dev_67810 App",
    "VERSION": "v1",
}
